...
event_map_t event_maps[] = {
    ...
    {"EVENT_REQ_CLOSE_APP_LAST_OPENED",            EVENT_REQ_CLOSE_APP_LAST_OPENED},
    {"EVENT_RES_CLOSE_APP_LAST_OPENED",            EVENT_RES_CLOSE_APP_LAST_OPENED},
    {"EVENT_RES_NO_APP_LAST_OPENED",               EVENT_RES_NO_APP_LAST_OPENED},
    ...
    {"EVENT_REQ_APP_CRASH_BY_APPNAME",             EVENT_REQ_APP_CRASH_BY_APPNAME},
    {"EVENT_RES_APP_CRASH_BY_APPNAME",             EVENT_RES_APP_CRASH_BY_APPNAME},
